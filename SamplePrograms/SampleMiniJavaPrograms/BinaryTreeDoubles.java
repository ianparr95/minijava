...
class BT {
	...
	ntb = root.Init(16.0);
	ntb = root.Print();
	System.out.println(100000000.0);
	ntb = root.Insert(8.0) ;
	ntb = root.Print();
	ntb = root.Insert(24.0) ;
	ntb = root.Insert(4.0) ;
	ntb = root.Insert(12.0) ;
	ntb = root.Insert(20.0) ;
	ntb = root.Insert(28.0) ;
	ntb = root.Insert(14.0) ;
	ntb = root.Print();
	System.out.println(root.Search(24.0));
	System.out.println(root.Search(12.0));
	System.out.println(root.Search(16.0));
	System.out.println(root.Search(50.0));
	System.out.println(root.Search(12.0));
	ntb = root.Delete(12.0);
	ntb = root.Print();
	System.out.println(root.Search(12.0));
