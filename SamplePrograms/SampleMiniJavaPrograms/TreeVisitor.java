...
class TreeVisitor{
	...
	System.out.println(new A().fail(5,6));
    }
}
/*
class TV {
...
class Tree{
    ...
    public Tree testFunction(Tree abc) {
	return left;
    }
    //Tree new_node ;
    //Tree current_node ;
...
class TreeE extends Tree {}

class A {
	int p;
	public int fail(int i, int k) {
		return p + 5;
	}
}
...
class C extends B {
	public int fail2(int i, int k, TreeE j){return 15 - 5;}
	public TreeE fail4(int i, int k, TreeE j){return 75 * 2;}
}
